...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
	...
	"files": {
		...
		"apache3": {
			"display" : "Apache Other VHost Access",
...
"php53web": {
"display" : "PHP 5.3 Error (Web)",
"path"    : "\/var\/log\/php\/php53-apache2.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"php53cli": {
"display" : "PHP 5.3 Error (CLI)",
"path"    : "\/var\/log\/php\/php53-cli.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"Log": ["\\/PHP Stack trace:\\/", "\\/PHP *[0-9]*\\. \\/"]
	...
	"php54web": {
		"display" : "PHP 5.4 Error (Web)",
		"path"    : "\/var\/log\/php\/php54-apache2.log",
		"refresh" : 5,
		"max"     : 10,
		"notify"  : true,
		"format"    : {
...
"php54cli": {
"display" : "PHP 5.4 Error (CLI)",
"path"    : "\/var\/log\/php\/php54-cli.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"php55web": {
"display" : "PHP 5.5 Error (Web)",
"path"    : "\/var\/log\/php\/php55-apache2.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"php55cli": {
"display" : "PHP 5.5 Error (CLI)",
"path"    : "\/var\/log\/php\/php55-cli.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"php56web": {
"display" : "PHP 5.6 Error (Web)",
"path"    : "\/var\/log\/php\/php56-apache2.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
...
"php56cli": {
"display" : "PHP 5.6 Error (CLI)",
"path"    : "\/var\/log\/php\/php56-cli.log",
"refresh" : 5,
"max"     : 10,
"notify"  : true,
"format"    : {
